...
function getExceptionSixReport($tablename,$verificationstatus,$reportHeaders)
    {
        ...
        if($verificationstatus==1)
        {
            ...
            $data['verified']=$this->db->query("SELECT item_category,SUM((total_item_amount_capitalized/quantity_as_per_invoice) * quantity_verified) as total_amount,SUM(quantity_verified) as total_items FROM ".$tablename." group by item_category")->result();
