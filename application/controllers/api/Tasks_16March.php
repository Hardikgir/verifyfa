      ...
      $data['AmountwiseBreakup_DonutChart_dataPoints']=$AmountwiseBreakup_DonutChart_dataPoints;
        ...
        $LineBreakTable =  [
            ...
            "data" => [
                [
                    ...
                    "amount_lacs" => "0.15",
                    "tagged_percent" => "50%",
                    "tagged_value" => "1 of 2 Li",
                    "verification_status" => "In Process"
                ],
                [
                    "category" => "F&F",
                    "amount_lacs" => "110.64",
                    "tagged_percent" => "16.67%",
                    "tagged_value" => "1 of 6 Li",
                    "verification_status" => "In Process"
                ],
                [
                    "category" => "TOTAL",
                    "amount_lacs" => "110.79",
                    "tagged_value" => "2 of 8 Li"
                ],
                [
                    "category" => "%",
                    "tagged_percent" => "25 %"
        ...
        $AmountWiseTable = [
            ...
            "data" => [
                [
                    "category" => "COMP",
                    "line_items" => "1 of 2 Li",
                    "tagged_percent" => "0%",
                    "tagged_value" => "0 of 0.15 Lacs",
                    "verification_status" => "In Process"
                ],
                [
                    "category" => "F&F",
                    "line_items" => "1 of 6 Li",
                    "tagged_percent" => "0.77%",
                    "tagged_value" => "0.85 of 110.64 Lacs",
                    "verification_status" => "In Process"
                ],
                [
                    "category" => "TOTAL",
                    "line_items" => "2 of 8 Li",
                    "tagged_value" => "0.85 of 110.79 Lacs"
                ],
                [
                    "category" => "%",
                    "tagged_percent" => "0.77%"
