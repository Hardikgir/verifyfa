										...
										<div class="row my-3">
											<div class="col-md-6">
												<div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="Mode of Verification">
												</div>
                                            </div>
                                            <div class="col-md-6">
												<div class="form-group">
		...
		<tr>
									...
									<table border="1" style="display:none">
										...
										<tr>
											...
											<th><?php echo $totalScanItems; ?></th>
											<th><?php echo $totalManualItems; ?></th>
										</tr>
										<tr>
											<td></td>
											<td><?php if($totalScanItems>0){ ?><a href="<?php echo base_url(); ?>index.php/dashboard/downloadExceptionEightReport/scan">Download to View Details</a><?php } ?></td>
											<td><?php if($totalManualItems>0){ ?><a href="<?php echo base_url(); ?>index.php/dashboard/downloadExceptionEightReport/manual">Download to View Details</a><?php } ?></td>
