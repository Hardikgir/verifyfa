							...
							<div class="card">
								...
								<div class="col-md-12" style="overflow-x:scroll;">
									<table border="1">
                                        ...
                                        ?>
                                            <tr><th colspan="2"  style="text-align:left;"><a href="<?php echo base_url(); ?>index.php/dashboard/downloadExceptionFiveConsolidatedReport/<?php echo  $data['project']->id; ?>" style="color:#5CA1E2;"><?php echo $data['project']->project_name;?>:</a></th></tr>
                                        <?php
