        ...
        data: [
            {
                ...
                yValueFormatString: "#,##0",
                color: "Green",
                dataPoints: <?php echo json_encode($AmountwiseBreakupChart_verified, JSON_NUMERIC_CHECK); ?>
            },{
                type: "stackedColumn100",
                name: "Not Verified",
                showInLegend: true,
                yValueFormatString: "#,##0",
                color: "Red",
                dataPoints: <?php echo json_encode($AmountwiseBreakupChart_nonverified, JSON_NUMERIC_CHECK); ?>
            }
        ]
    });
