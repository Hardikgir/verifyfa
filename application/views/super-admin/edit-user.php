...
<!-- Section: Testimonials v.2 -->
	<div class="content">
        ...
        <div class="col-lg-12 mt-4 mb-4" style="border-bottom:1px solid #6e50505e;">
            <h4 class="page-title">Edit Registration Detail</h4>
       </div>     

			<div class="col-lg-12">
            <form action="<?php echo base_url();?>index.php/save-edit-registred-user" method="post" id="step1">
            ...
            <section class="text-center">
             ...
             <div class="row">
                <div class="col-md-6 form-row">
                    ...
                    <input type="email" name="email_id"  id="email_id"class="form-control" placeholder="Enter Email Id" required  value="<?php echo $user_data->email_id;?>">
                </div>
                <div class="col-md-6 form-row">
 ...
 <?php } ?>
            ...
            <div class="row">
                <div class="col-md-6 form-row">
                    ...
                    <option value="<?php echo $plan_row->id;?>"><?php echo $plan_row->title;?></option>    
                </select>
                </div>
                <div class="col-md-6 form-row">
                    <label class="form-label">Validity of Subscription </label>
                    <input type="number" name="subscription_time_value" id="validity" class="form-control" placeholder="Only Numeric Value Allow" required id="validity" min="1" onkeydown="if(event.key==='.'){event.preventDefault();}"  oninput="event.target.value = event.target.value.replace(/[^0-9]*/g,'');" value="<?php echo $plan_data->subscription_time_value;?>">
                </div>
             </div>
             <br>
             ...
             <div class="row">
                ...
                <label class="form-label">Period of Subscription </label>
                    <select name="time_subscription" class="form-control"  required id="period">
                        <option value="<?php echo $plan_data->time_subscription;?>"><?php echo $plan_data->time_subscription;?></option>
             ...
             <div class="col-md-6 form-row">
                    ...
                    <input type="date" class="form-control" name="plan_start_date" id="start_date" value="<?php echo $plan_data->plan_start_date;?>">
                </div>
                <div class="col-md-6 form-row">
                <label class="form-label">End Date of Subscription </label>
                <input type="date" class="form-control" id="plan_end_date" name="plan_end_date"  readonly value="<?php echo $plan_data->plan_end_date;?>">
                </div>
             ...
             <div class="col-md-6 form-row">
                    ...
                    <option value="Original" <?php if($plan_data->category_subscription == 'Original'){echo "selected";}?>>Original</option>
                    <option value="Upgrade" <?php if($plan_data->category_subscription == 'Upgrade'){echo "selected";}?>>Upgrade</option>
                    <option value="Renewal" <?php if($plan_data->category_subscription == 'Renewal'){echo "selected";}?>>Renewal</option>
                    <option value="Reactivation" <?php if($plan_data->category_subscription == 'Reactivation'){echo "selected";}?>>Reactivation</option>
                    </select>
                </div>
                <div class="col-md-6 form-row">
                    <label class="form-label">Credit Period (days) of Subcription allowed after expiry (before account suspension)</label>
                    <input type="number" class="form-control" name="credit_days" id="credit_days" min="0" value="<?php echo $plan_data->credit_days;?>">
                </div>
             </div>
             <br>
        ...
        <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
            <div class="row">
                ...
                <input type="number" class="form-control" name="amount_subs_due"  id="amount_subs_due" required readonly value="<?php echo $user_data->balance_due;?>">
                </div>
                <div class="col-md-6 form-row">
                    <label class="form-label">Other Charges </label>
                    <input type="number" class="form-control" name="paymentother_charge"  id="paymentother_charge"   min="0" value="0">
                </div>
             </div>
             <br>
             ...
             <div class="row">
                ...
                <input type="number" class="form-control" name="discount_credits"  id="discount_credits"  value="0" onchange="forceLimit(this.value)">
                <p id="alertdiscountcredit"></p>    
            </div>
                <div class="col-md-6 form-row">
                    <label class="form-label">Total Amount payable</label>
                    <input type="number" class="form-control" name="total_amount_payble"  id="total_amount_payble" required readonly value="<?php echo $user_data->balance_due;?>">
                </div>
             </div>
             <br>
             ...
             <div class="row">
                ...
                <div class="col-md-6 form-row">
                    ...
                    <input type="number" class="form-control" name="balance_refundable"  id="balance_refundable" readonly value="<?php echo $user_data->balance_due;?>">
                </div>
             </div>
             <br>
             ...
             <div class="row">
                ...
                <div class="col-md-6 form-row">
                    ...
                    <select class="form-control" name="mode_of_payment"  id="balance_refunmode_of_paymentdable">
             ...
             <div class="row">
                ...
                <input type="text" class="form-control" name="transection_ref"  id="transection_ref">
                </div>
                <div class="col-md-6 form-row">
                    <label class="form-label">Payment Remarks</label>
                    <input type="text" class="form-control" name="payment_remarks"  id="payment_remarks">
                </div>
             </div>
             <br>
             <!-- <div class="row">
...
<script>
    ...
    var total_amount_payble=   $("#amount_subs_due").val();
