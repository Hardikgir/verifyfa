...
ClassicEditor.create( document.querySelector( '.editornew1' ) ).then( editor => {
console.log( editor );
} ).catch( error => {
} );

ClassicEditor.create( document.querySelector( '.editornew2' ) ).then( editor => {
console.log( editor );
} ).catch( error => {
} );

ClassicEditor.create( document.querySelector( '.editornew3' ) ).then( editor => {
console.log( editor );
} ).catch( error => {
} );

ClassicEditor.create( document.querySelector( '.editornew4' ) ).then( editor => {
console.log( editor );
} ).catch( error => {
} );
</script>
