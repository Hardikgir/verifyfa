										...
										<div class="row my-3">
											<div class="col-md-6">
												<div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="With Item Note">
												</div>
                                            </div>
                                            <div class="col-md-6">
												<div class="form-group">
								...
								<div class="col-md-12" style="overflow-x:scroll;">
									<table border="1">
										...
										<tr>
											...
											<td><a href="<?php echo base_url(); ?>index.php/dashboard/downloadExceptionFiveReport/<?php echo urlencode($allcat->item_category); ?>">Download to View Details</a></td>
										</tr>
										<?php
										}
										?>
										...
										<tr>
											<td></td>
											<td><?php if($totalItems>0){ ?><a href="<?php echo base_url(); ?>index.php/dashboard/downloadExceptionFiveAllReport">Download to View Details</a><?php } ?></td>
											<td></td>
